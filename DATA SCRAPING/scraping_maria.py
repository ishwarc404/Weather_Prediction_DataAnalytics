...
irenebuoy = ["41047"]#,"41046","41056","41058" ,"41043", "41041"]  # bouynumber array
year = "2017"  # year
...
for i in irenebuoy:
    ...
    with open("textfiles/maria/"+i + ".txt", 'wb') as f:
...
for i in irenebuoy:
    ...
    f = open("textfiles/maria/"+i + '.txt', 'r')
...
for index, rows in maindf.iterrows():
    ...
    if ((i.day > 1) and (i.day < 29) and (i.month == 9)):
        maindf.loc[index, 'hurrthreat'] = 1
maindf['DaysTH'] = 0
j = datetime.datetime(2017,9,16)
...
maindf.to_csv("final_csv/MARIACSV.csv")
